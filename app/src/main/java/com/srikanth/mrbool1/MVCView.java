...
import com.srikanth.mrbool1.R;

import java.util.List;

public class MVCView extends Activity {
    public static final String APP_TAG = "com.srikanth.mrbool1";
        ...
        public void onItemClick(final AdapterView<?> parent, final View view, final int position, final long id)
            {
                ...
                final TextView v = (TextView) view; MVCView.this.controller.deleteTask (v.getText().toString());
    ...
    private final View.OnClickListener handleNewTaskEvent = new View.OnClickListener()
    {
...

        {
            ...
            MVCView.this.controller.addTask(MVCView.this .etNewTask.getText().toString());
            MVCView.this.populateTasks();
            etNewTask.setText("");
        }
    };
